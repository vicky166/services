  ...
  return (
    <header className="flex h-20 w-full shrink-0 items-center px-4 md:px-6 bg-[#2F5649] text-white">
      <Sheet>
        ...
        <SheetContent
          side="left"
          className="bg-[#2F5649] text-white border-r-0"
        >
          ...
          <div className="grid gap-2 py-6">
            <Link
              href="#"
              className="block py-2 text-lg font-semibold hover:text-white/90"
            >
              Aesthetic Clinic
            </Link>
            <Link
      ...
      <div className="ml-auto flex items-center gap-4">
        ...
        <Button className="bg-[#E5D5CA] text-[#2F5649] hover:bg-[#E5D5CA]/90">
          Book Now
        </Button>
